...
这是个例子，将Android library打包成aar发布到jcenter的项目 (This is a help Android developer to AAR jcenter project released) <BR/>
具体信息可下载此项目在Android Studio中打开LibToJcenter
...
打开终端（如图）
<img src='./showImg/cmd.png' width='400' height='auto'> <br/>
